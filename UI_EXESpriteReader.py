...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsScaleSlider = QtGui.QSlider(self.centralwidget)
        ...
        self.graphicsScaleSlider.setObjectName(_fromUtf8("graphicsScaleSlider"))
        ...
        QtCore.QObject.connect(self.graphicsScaleSlider, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), MainWindow.changeViewScale)
        QtCore.QObject.connect(self.importAction, QtCore.SIGNAL(_fromUtf8("triggered()")), MainWindow.importSprite)
        QtCore.QObject.connect(self.animList, QtCore.SIGNAL(_fromUtf8("itemDoubleClicked(QListWidgetItem*)")), MainWindow.repointAnimation)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "ロックマンエグゼ スプライトリーダー ver 1.5 by ideal", None))
        self.spriteLabel.setText(_translate("MainWindow", "スプライト", None))
        self.graphicsLabel.setText(_translate("MainWindow", "スプライトビュー", None))
        self.graphicsScaleSlider.setStatusTip(_translate("MainWindow", "表示サイズを変更できます", None))
        self.animLabel.setText(_translate("MainWindow", "アニメーション", None))
        self.animList.setStatusTip(_translate("MainWindow", "アイテムをダブルクリックするとアニメーションをリポイントできます", None))
        ...
        self.palList.setStatusTip(_translate("MainWindow", "アイテムをダブルクリックすると色を変更できます", None))
        ...
        self.importAction.setText(_translate("MainWindow", "インポート", None))
        self.importAction.setStatusTip(_translate("MainWindow", "指定したアドレスにファイルから読み込んだスプライトをインポートします", None))
        self.linkAction.setText(_translate("MainWindow", "リンク（未実装）", None))
        self.aboutAction.setText(_translate("MainWindow", "このツールについて（未実装）", None))
