...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.useDefaultPalBox = QtWidgets.QCheckBox(self.centralwidget)
        self.useDefaultPalBox.setChecked(True)
        self.useDefaultPalBox.setTristate(False)
        self.useDefaultPalBox.setObjectName("useDefaultPalBox")
        self.oamLayout.addWidget(self.useDefaultPalBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.useDefaultPalBox.setText(_translate("MainWindow", "OAM指定のパレットで表示"))
